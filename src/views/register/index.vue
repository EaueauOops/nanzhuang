    ...
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form" auto-complete="on" label-position="left">
      ...
      <el-form-item label="角色">
        <el-radio-group v-model="registerForm.type" size="medium">
          ...
          <el-radio label="merchant">商户用户</el-radio>
          <el-radio label="admin">管理员</el-radio>
        </el-radio-group>
      </el-form-item>

      <el-button type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="resetForm('registerForm')">重置</el-button>
